...
<div class="section-body">
    <p>
        Homebrew Launcher主題中，每頁可存放最多40個軟體。 您可以通過&#xE004; 和&#xE005; 來切換頁面。
    </p>
    <ul>
...
<div class="section-body">
    <p>
        沒有更改設定時, 在Homebrew Launcher主題下, 按SELECT進入DS Classic選單. 但是, 當設定為"Select選單"時, 按下SELECT會顯示一個小選單. 下為SELECT選單的說明
    </p>
    <ul>
