...
title: Temă R4 Original
---

<div id="main-menu" class="section-title">Meniu Principal</div>
<div class="section-body">
    <div class="button-action-group">
        <p class="button-action button">&#xE07E;</p>
        <p class="button-action-text">Opțiunea Ante./Urm.</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action button">&#xE000;</p>
        <p class="button-action-text">Deschideți opțiunea selectată</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action button">&#xE001;</p>
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">Deschideți opțiune</p>
    </div>
</div>

<div id="file-browser" class="section-title">Browser de fișiere</div>
<div class="section-body">
    <div class="button-action-group">
        <p class="button-action button">&#xE07D;</p>
    ...
    <div class="button-action-group">
        <p class="button-action button">&#xE001;</p>
        <p class="button-action-text">Urcați un nivel de dosare</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action button">&#xE002;</p>
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">Întoarceți-vă la Meniul Principal</p>
    </div>
</div>
