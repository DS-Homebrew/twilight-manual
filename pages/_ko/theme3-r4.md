...
<div class="section-body">
    <div class="button-action-group">
        ...
        <p class="button-action-text">이전 / 다음 옵션</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action button">&#xE000;</p>
        <p class="button-action-text">선택한 옵션 열기</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action button">&#xE001;</p>
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">옵션 열기</p>
    </div>
</div>

<div id="file-browser" class="section-title">파일 탐색기</div>
<div class="section-body">
    <div class="button-action-group">
        <p class="button-action button">&#xE07D;</p>
