...
<div class="section-body">
    <p>
        Tema SEGA Saturn membagi butirnya berhalaman dengan jumlah batasnya 40 butir tiap halaman. Kamu bisa menavigasi halaman dengan tombol &#xE004; dan &#xE005;.
    </p>
    <ul>
...
<div class="section-body">
    <p>
        Menekan SELECT di tema SEGA Saturn akan menampilkan menu DS Klasik secara bawaan (default). Namun, kamu bisa mengubahnya di pengaturan TWiLight Menu++ menjadi Menu SELECT, yaitu menu miniatur yang tersemat (embedded) di dalam temanya. Berikut pilihan menu pada Menu SELECT.
    </p>
    <ul>
