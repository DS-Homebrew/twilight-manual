...
<div class="section-body">
    <p>
        GBARunner2 dapat memakai dump BIOS GBA resmi untuk menambah kesesuaian (compatibility). Berkasnya harus bernama <code>bios.bin</code> dan taruhnya boleh di root kartu SD, di <code>sd:/gba</code> atau <code>sd:/_gba</code>.
    </p>
    <hr>
    <p>
