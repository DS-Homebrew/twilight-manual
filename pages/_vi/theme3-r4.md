...
<div class="section-body">
    ...
    <div class="button-action-group">
        <p class="button-action button">&#xE001;</p>
        <p class="button-action-text">Khởi động lại TWiLight Menu++</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action">START / SELECT</p>
        <p class="button-action-text">Mở cài đặt</p>
    </div>
    <hr>
    <div class="button-action-group">
...
<div id="file-browser" class="section-title">Duyệt tệp</div>
<div class="section-body">
    <div class="button-action-group">
        <p class="button-action button">&#xE07D;</p>
    ...
    <div class="button-action-group">
        <p class="button-action button">&#xE000;</p>
        <p class="button-action-text">Chạy ứng dụng đã chọn</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action button">&#xE001;</p>
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">Trở lại Menu chính</p>
    </div>
</div>
