...
<div class="section-body">
    <p>
        El tema Homebrew Launcher divide elementos en páginas con un máximo de 40 elementos por página. You can navigate through the pages using the &#xE004; and &#xE005; triggers.
    </p>
    <ul>
