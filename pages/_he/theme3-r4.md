...
title: ערכת הנושא R4 Original
---

<div id="main-menu" class="section-title">תפריט ראשי</div>
<div class="section-body">
    <div class="button-action-group">
        <p class="button-action button">&#xE07E;</p>
        <p class="button-action-text">האפשרות הקודמת \ הבאה</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action button">&#xE000;</p>
        <p class="button-action-text">פתיחת האפשרות שנבחרה</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action button">&#xE001;</p>
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">פתיחת אפשרות</p>
    </div>
</div>

<div id="file-browser" class="section-title">סייר הקבצים</div>
<div class="section-body">
    <div class="button-action-group">
        <p class="button-action button">&#xE07D;</p>
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">חזרה לתפריט הראשי</p>
    </div>
</div>
