...
<div class="section-title">Vorübergehend deaktiviert</div>
...
<div class="section-body">
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">Öffne das Startmenü</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action">SELECT</p>
        <p class="button-action-text">Ansichtsmodus ändern</p>
    </div>
</div>
