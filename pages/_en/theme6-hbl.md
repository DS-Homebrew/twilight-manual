...
<div class="section-body">
	<p>
		The Homebrew Launcher UI splits items into pages with a maximum of 40 items per page. You can navigate through the pages using the &#xE004; and &#xE005; triggers.
	</p>
	<ul>
...
<div class="section-body">
	<p>
		Pressing SELECT in the Homebrew Launcher UI will bring up the DS Classic Menu by default. However, in the TWiLight Menu++ settings, you can change it to launch the SELECT Menu, a miniature menu embedded inside the UI itself. Here are the menu options for the SELECT Menu.
	</p>
	<ul>
