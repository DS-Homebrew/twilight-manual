...
<div class="section-body">
    ...
    <div class="button-action-group">
        <p class="button-action button">&#xE000;</p>
        <p class="button-action-text">Abrir opção selecionada</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action button">&#xE001;</p>
        <p class="button-action-text">Sair para o Menu Inicial DSi/3DS</p>
    </div>
    <hr>
    <div class="button-action-group">
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">Abrir opção</p>
    </div>
</div>

<div id="file-browser" class="section-title">Explorador de arquivos</div>
<div class="section-body">
    <div class="button-action-group">
        <p class="button-action button">&#xE07D;</p>
        <p class="button-action-text">Item anterior / seguinte</p>
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">Retornar ao menu principal</p>
    </div>
</div>
