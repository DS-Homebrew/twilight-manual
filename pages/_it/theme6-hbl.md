...
<div class="section-body">
    <p>
        Premere SELECT nel tema Homebrew Launcher apre il Menu Classico DS per impostazione predefinita. Tuttavia, nelle impostazioni di TWiLight Menu++, è possibile modificarlo per avviare il menu SELECT, un menu in miniatura incorporato all'interno del tema stesso. Ecco le opzioni del menu SELECT.
    </p>
    <ul>
