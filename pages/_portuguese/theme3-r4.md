...
<div class="section-body">
    ...
    <div class="button-action-group">
        <p class="button-action button">&#xE000;</p>
        <p class="button-action-text">Abrir opção seleccionada</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action button">&#xE001;</p>
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">Opção aberta</p>
    </div>
</div>

<div id="file-browser" class="section-title">Explorador de Ficheiros</div>
<div class="section-body">
    <div class="button-action-group">
        <p class="button-action button">&#xE07D;</p>
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">Voltar para o Menu Principal</p>
    </div>
</div>
