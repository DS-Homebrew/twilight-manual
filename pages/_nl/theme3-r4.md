...
title: R4 Origineel Thema
---

<div id="main-menu" class="section-title">Hoofdmenu</div>
<div class="section-body">
    ...
    <div class="button-action-group">
        <p class="button-action button">&#xE000;</p>
        <p class="button-action-text">Open de geselecteerde optie</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action button">&#xE001;</p>
        <p class="button-action-text">Afsluiten naar DSi/3DS Home Menu</p>
    </div>
    <hr>
    <div class="button-action-group">
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">Optie openen</p>
    </div>
</div>

<div id="file-browser" class="section-title">Bestandsbeheer</div>
<div class="section-body">
    <div class="button-action-group">
        <p class="button-action button">&#xE07D;</p>
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">Terug naar hoofdmenu</p>
    </div>
</div>
