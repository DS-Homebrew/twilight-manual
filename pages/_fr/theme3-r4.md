...
<div class="section-body">
    ...
    <div class="button-action-group">
        <p class="button-action button">&#xE000;</p>
        <p class="button-action-text">Ouvrir l'option sélectionnée</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action button">&#xE001;</p>
        <p class="button-action-text">Revenir au menu HOME DSi/3DS</p>
    </div>
    <hr>
    <div class="button-action-group">
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">Ouvrir l'option</p>
    </div>
</div>

<div id="file-browser" class="section-title">Explorateur de fichiers</div>
<div class="section-body">
    <div class="button-action-group">
        <p class="button-action button">&#xE07D;</p>
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">Retour au menu principal</p>
    </div>
</div>
