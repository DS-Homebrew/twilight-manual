...
<div class="section-body">
    <p>
        Menekan SELECT di tema Homebrew Launcher akan menampilkan menu DS Klasik secara asali (default). Namun, kamu dapat mengubahnya di pengaturan TWiLight Menu++ menjadi Menu SELECT, yaitu menu bentuk kecil yang terbenam (embedded) di dalam temanya. Berikut pilihan menu pada Menu SELECT.
    </p>
    <ul>
