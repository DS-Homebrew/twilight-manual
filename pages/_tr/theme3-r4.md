...
<div class="section-body">
    ...
    <div class="button-action-group">
        <p class="button-action button">&#xE000;</p>
        <p class="button-action-text">Seçili ayarı aç</p>
    </div>
    <hr>
    <div class="button-action-group">
        <p class="button-action button">&#xE001;</p>
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">Seçeneği Aç</p>
    </div>
</div>

<div id="file-browser" class="section-title">Dosya Yöneticisi</div>
<div class="section-body">
    <div class="button-action-group">
        <p class="button-action button">&#xE07D;</p>
    ...
    <div class="button-action-group">
        ...
        <p class="button-action-text">Ana Menü'ye Dön</p>
    </div>
</div>
