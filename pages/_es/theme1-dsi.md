...
<div class="section-body">
    <p>
        El tema Nintendo DSi divide los elementos en páginas con un máximo de 40 elementos por página. Puedes navegar a través de las páginas con los gatillos &#xE004; y &#xE005;:
    </p>
    <ul>
...
<div class="section-body">
    ...
    <p>TWiLight Menu++ puede mostrar fotos personalizadas en la pantalla superior, como en el menú oficial de Nintendo DSi. Sin embargo, en lugar de sacarlo de la aplicación de la Cámara de Nintendo DSi, puedes colocar imágenes PNG en <code class="language-plaintext wrap">sd:/_nds/TWiLightMenu/dsimenu/photos</code></p>
    <ul>
...
<div class="section-body">
    <p>
        Pulsa SELECT en el tema Nintendo DSi para que, por defecto, aparezca el Menú Clásico DS. Sin embargo, en los ajustes de TWiLight Menu++, puedes cambiarlo por el Menú SELECT, un menú en miniatura dentro del propio tema. Estas son las opciones del Menú SELECT:
    </p>
    <ul>
